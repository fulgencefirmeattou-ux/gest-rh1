...
<head>
    <meta charset="utf-8" />
    <title>403 - Accès refusé | GRH</title>
                ...
                <div class="col-xxl-5 col-lg-6 col-md-8">
                    <div class="card overflow-hidden text-center">
                        <div class="card-body p-5">
                            <div class="mb-4">
                                <span class="display-1 fw-bold text-danger">403</span>
                            </div>
                            <div class="mb-3">
                                <i class="ri-shield-keyhole-line" style="font-size: 4rem; color: #dc3545;"></i>
                            </div>
                            <h3 class="fw-bold text-dark mb-2">Accès refusé</h3>
                            ...
                            <div class="d-flex justify-content-center gap-2">
                                ...
                                <a href="{{ route('dashboard') }}" class="btn btn-soft-primary">
