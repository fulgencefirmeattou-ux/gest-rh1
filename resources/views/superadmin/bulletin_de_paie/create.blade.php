                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="month" name="mois" id="mois" class="form-control form-control-sm"
                                   value="{{ old('mois', $moisCourant) }}" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label small">Nbre de parts</label>
                            <input type="number" name="nbre_parts" id="nbre_parts" class="form-control form-control-sm calcul"
                                   value="{{ old('nbre_parts', 1) }}" step="0.5" min="0.5">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="reference_virement" class="form-control form-control-sm"
                                   value="{{ old('reference_virement') }}" placeholder="Ex: 0100 123456789">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" name="salaire_base" id="salaire_base"
                                   class="form-control form-control-sm calcul"
                                   value="{{ old('salaire_base') }}" min="0" step="1" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label small">Avantage en nature</label>
                            <input type="number" name="avantage_nature" id="avantage_nature"
                                   class="form-control form-control-sm calcul"
                                   value="{{ old('avantage_nature', 0) }}" min="0" step="1">
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="number" name="indemnite_transport" id="indemnite_transport"
                                   class="form-control form-control-sm calcul"
                                   value="{{ old('indemnite_transport', 0) }}" min="0" step="1">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label small">Brut imposable</label>
                            <input type="number" name="brut_imposable" id="brut_imposable"
                                   class="form-control form-control-sm calcul"
                                   value="{{ old('brut_imposable') }}" min="0" step="1"
                                   placeholder="= salaire brut si vide">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label small">Plafond CNPS (défaut 70 000)</label>
                            <input type="number" name="cnps_plafond" id="cnps_plafond"
                                   class="form-control form-control-sm calcul"
                                   value="{{ old('cnps_plafond', 70000) }}" min="0" step="1">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label small">Base CMU (défaut 1 000)</label>
                            <input type="number" name="cmu_base" id="cmu_base"
                                   class="form-control form-control-sm calcul"
                                   value="{{ old('cmu_base', 1000) }}" min="0" step="1">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" name="cumul_gains" class="form-control form-control-sm"
                                   value="{{ old('cumul_gains') }}" min="0" step="1">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label small">Cumul retenues</label>
                            <input type="number" name="cumul_retenues" class="form-control form-control-sm"
                                   value="{{ old('cumul_retenues') }}" min="0" step="1">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label small">Brut imposable cumulé</label>
                            <input type="number" name="brut_imposable_cumul" class="form-control form-control-sm"
                                   value="{{ old('brut_imposable_cumul') }}" min="0" step="1">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label small">Base congé</label>
                            <input type="number" name="base_conge" class="form-control form-control-sm"
                                   value="{{ old('base_conge') }}" min="0" step="1">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label small">Jours fiscaux</label>
                            <input type="number" name="jours_fiscaux" class="form-control form-control-sm"
                                   value="{{ old('jours_fiscaux') }}" min="0">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-0">
                    <table class="table table-sm table-bordered mb-0" style="font-size:12px;">
                        <thead class="table-light">
                            <tr><th colspan="2" class="text-center bg-success bg-opacity-10">Charges patronales (Taux P.P)</th></tr>
                        </thead>
                        <tbody>
                            <tr><td>Impôt Employeur (IS 1,20 %)</td><td class="text-end" id="p_is_employeur">—</td></tr>
                            <tr><td>F.D.F.P / T.A (0,40 %)</td><td class="text-end" id="p_fdfp_ta">—</td></tr>
                            <tr><td>F.D.F.P / F.P.C (0,60 %)</td><td class="text-end" id="p_fdfp_fpc">—</td></tr>
                            <tr class="table-light fw-semibold"><td>Total charges fiscales emp.</td><td class="text-end" id="p_total_fisc_emp">—</td></tr>
                            <tr><td>C.N.P.S / Prest. Familiale (5,75 %)</td><td class="text-end" id="p_cnps_pf">—</td></tr>
                            <tr><td>C.N.P.S / Accident Travail (5,00 %)</td><td class="text-end" id="p_cnps_at">—</td></tr>
                            <tr><td>C.N.P.S / Caisse Retraite (7,70 %)</td><td class="text-end" id="p_cnps_retraite">—</td></tr>
                            <tr><td>C.M.U / Ass. Maladie (50 %)</td><td class="text-end" id="p_cmu_emp">—</td></tr>
                            <tr class="table-light fw-semibold"><td>Total charges sociales emp.</td><td class="text-end" id="p_total_soc_emp">—</td></tr>
                            <tr class="fw-bold table-warning"><td>Total charges patronales</td><td class="text-end" id="p_total_patronales">—</td></tr>
                        </tbody>
                        <thead class="table-light">
                            <tr><th colspan="2" class="text-center bg-danger bg-opacity-10">Retenues salariales</th></tr>
                        </thead>
                        <tbody>
                            <tr><td>Retenue I.S (1,20 %)</td><td class="text-end" id="p_retenue_is">—</td></tr>
                            <tr><td>Retenue C.N</td><td class="text-end" id="p_retenue_cn">—</td></tr>
                            <tr><td>Retenue I.G.R</td><td class="text-end" id="p_retenue_igr">—</td></tr>
                            <tr><td>Retenue C.N.P.S (6,30 %)</td><td class="text-end" id="p_retenue_cnps">—</td></tr>
                            <tr><td>Retenue C.M.U (50 %)</td><td class="text-end" id="p_retenue_cmu">—</td></tr>
                            <tr class="fw-bold table-danger text-white" style="background:#dc3545"><td>Total retenues</td><td class="text-end" id="p_total_retenues">—</td></tr>
                        </tbody>
                        <thead class="table-light">
                            <tr><th colspan="2" class="text-center">Résultat</th></tr>
                        </thead>
                        <tbody>
                            <tr><td>Salaire brut</td><td class="text-end fw-bold" id="p_salaire_brut">—</td></tr>
                            <tr><td>Salaire net</td><td class="text-end fw-bold" id="p_salaire_net">—</td></tr>
                            <tr class="fw-bold" style="background:#198754;color:#fff"><td>NET À PAYER</td><td class="text-end" id="p_net_a_payer">—</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
