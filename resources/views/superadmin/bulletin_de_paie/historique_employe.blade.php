...
<div class="container-fluid mt-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('bulletins.create') }}?employe_id={{ $employe->id }}"
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-flex gap-1 justify-content-center">
                                        <a href="{{ route('bulletins.show', $b) }}"
                                           class="btn btn-outline-primary btn-sm" title="Voir">
                                            <i class="ri-eye-line"></i>
                                        </a>
                                        <a href="{{ route('bulletins.download', $b) }}"
                                        ...
                                        @endif
                                        @if($b->statut !== 'paye')
                                            <form method="POST" action="{{ route('bulletins.destroy', $b) }}"
