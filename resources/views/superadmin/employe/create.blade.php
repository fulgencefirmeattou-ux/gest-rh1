        ...
        <form action="{{ route('employes.store') }}" method="POST" class="bg-white p-4 rounded shadow-sm" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="nom" id="nom" @error('nom') is-invalid @enderror class="form-control" value="{{ old('nom') }}">
                </div>
                <div class="col-md-6">
                    <label for="prenom" class="form-label">Prénom</label>
                    <input type="text" name="prenom" id="prenom"    @error('prenom') is-invalid @enderror class="form-control" value="{{ old('prenom') }}">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="salaire" id="salaire" class="form-control" value="{{ old('salaire') }}" min="0">
                </div>
            </div>
